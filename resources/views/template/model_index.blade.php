                    ...
                    <div class="col-xs-8">
                        <div class="row pull-left box-tools ">
                            ...
                            <div class="btn-group btn-group-sm">
                                <a id="btn-nuevo" href="{{ \Illuminate\Support\Facades\Request::segment(2) == 'budgets' ? route('moto.budgets.create') : route(config('models.'.$section.'.createRoute'))}}" class="btn btn-default" title="Nuevo"><i class="fa fa-plus-square-o"></i></a>
