                    ...
                    <div class="col-xs-8">
                        <div class="row pull-left box-tools ">
                            ...
                            <div class="btn-group btn-group-sm">
                                ...
                                <button id="edit_btn" route_edit="{{ \Illuminate\Support\Facades\Request::segment(2) == 'budgets' ? route(config('models.'.$section.'.editRoute')) : route(config('models.'.$section.'.editRoute'))}}" class="btn btn-default" title="Editar" ><i class="fa fa-edit"></i></button>
                            </div>
                            <div class="btn-group btn-group-sm">
                                ...
                                {{--<a href="{{ route('configs.inputs',$section) }}" class="btn btn-default" title="Configurar" ><i class="fa fa-gear"></i></a>--}}
