    ...
    <div style="position:absolute; bottom:0;padding-top:15px;">
        <div class="row" style="height: 100px;">
            <table class="bloque1 no-border">
                <tr>
                    <td class="col-xs-6">
                        <h1 style="font-size:12px;">Atendido por:</b> {!! $model->users->fullName or '' !!}</h1>

                    </td>
                    <td class="col-xs-3">
                        {!!  DNS2D::getBarcodeHTML($model->id, "QRCODE",3.3,3.3,'black') !!}
                    </td>
                    <td class="col-xs-3">
                        {!!  DNS1D::getBarcodeHTML($model->id, "EAN13",2,33, 'black') !!}
                    </td>
                </tr>
