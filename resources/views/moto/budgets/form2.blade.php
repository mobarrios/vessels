    ...
    <div class="modal-body">
        <div ng-app="buscador">
            ...
            <div class="col-xs-12 form-group">
                ...
                {{--{!! Form::label('search', "Buscar prospecto") !!}--}}
                {{--{!! Form::text('search', null, ['class'=>'form-control','placeholder' => 'Ingrese datos...','id' => 'search']) !!}--}}
            </div>

            <div>
                {!! Form::open(['route'=> [config('models.clients.storeRoute')],  'title' =>"Crear prospecto",'ngApp' => 'buscador','ng-controller' => 'buscadorController']) !!}
                ...
                <div class="col-xs-12 col-lg-3 form-group">
                    {!! Form::label('email', "DNI") !!}
                    {!! Form::text('email', null, ['class'=>'form-control','required' => 'required','ng-model' => 'email']) !!}
                </div>
...
//            $http.get("moto/clients/"+option.value)
//                    .then(function (response) {
//                        console.log(response)
//                        $scope.last_name = response['last_name']
//                        $scope.name = response['name']
//                        $scope.dni = response['dni']
//                        $scope.sexo = response['sexo']
//                        $scope.nacionality = response['nacionality']
//                        $scope.phone1 = response['phone1']
