...
<div style="margin-bottom: 100px !important;margin-top: -30px;">
    ...
    <div class="text-center col-xs-4" style="float:right;">
        <p class="upper">Constancia de recepción</p>
        <p>N: 00001</p>
        <p>Fecha Impresión: 16/01/2017</p>
    </div>
...
<div class="row">
    ...
    <div class="col-xs-4">
        <p class="text-left">Firma Receptor:</p>
    </div>
