...
<body>
    ...
    <div class="datos-cliente" style="margin-top:50px">
        ...
        <div class="contenedor-dato-cliente">
            <span class="upper"><b>Destino: </b></span> <span class="upper text-muted">MOTO PLANET DON TORCUATO</span>
        </div>

        <div class="separador"></div>

        <div class="contenedor-dato-cliente">
            <span class="upper"><b>Dirección: </b></span> <span class="upper text-muted">av. mt. alvear 2731</span>
        </div>

        <div class="separador"></div>

        <div class="contenedor-dato-cliente">
            <span class="upper"><b>Localidad: </b></span> <span class="upper text-muted">don torcuato</span>
        </div>
         ...
         <table class="table table-responsive">
             <tbody>
                 ...
                 <tr>
                    ...
                    <td>S315ASD1351</td>
                    <td></td>
                    <td class="mini-text">MOTO PLANET DON TORCUATO</td>
