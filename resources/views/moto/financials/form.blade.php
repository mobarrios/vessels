...
@section('form_inputs')
    ...
    <div class="col-xs-4 col-lg-4  form-group" style="padding-top: 2%">
        ...
        @if(isset($models))
            <a href="#" data-action="{!! route("moto.financials.addDue") !!}" data-toggle="control-sidebar"
    ...
    @if(isset($models))
            ...
            <table class="table">
                ...
                @foreach($models->FinancialsDues as $item)
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{route('moto.financials.deleteDue',[$item->id,$models->id])}}"><span
                                        class="text-danger fa fa-trash"></span></a>
                        </td>
                        <td>
                            <a href="{{route('moto.financials.editDue',[$item->id,$models->id])}}"><span
        ...
        @if(isset($modelItems))
            {!! Form::model($modelItems,['route'=> ['moto.financials.updateDue', $modelItems->id,$models->id], 'files' =>'true']) !!}
        @else
            {!! Form::open(['route'=> ['moto.financials.addDue' ], 'files' =>'true']) !!}
        @endif
