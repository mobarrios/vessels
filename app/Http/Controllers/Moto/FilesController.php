...
//        $this->repo->create($model);
    ...
    {
        $this->data["forms01"] = $this->forms->where('forms_types',1)->where('status',1)->lists('id','number');
        $this->data["forms12"] = $this->forms->where('forms_types',2)->where('status',1)->lists('id','number');
        $this->data["forms59"] = $this->forms->where('forms_types',3)->where('status',1)->lists('id','number');
