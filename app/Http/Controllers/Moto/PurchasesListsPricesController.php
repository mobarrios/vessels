...
use App\Http\Repositories\Moto\PurchasesListsPricesItemsRepo;
use App\Http\Repositories\Moto\PurchasesListsPricesRepo as Repo;
...
class PurchasesListsPricesController extends Controller
{
    ...
    public function deleteItems(PurchasesListsPricesItemsRepo $purchasesListsPricesItemsRepo)
    {
        $purchasesListsPricesItemsRepo->destroy($this->route->getParameter('id'));

        return redirect()->route('moto.purchasesListsPrices.edit',$this->route->getParameter('model'));
    }
