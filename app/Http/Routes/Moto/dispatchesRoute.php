...
Route::group(['prefix' => 'dispatches'], function () {
    ...
    Route::get('/purchasesItems/{purchasesOrdersId?}/{dispatchesId?}', ['middleware' => 'permission:' . $section . '.list', 'as' => 'moto.dispatches.purchasesItems', 'uses' => 'Moto\DispatchesController@purchasesItems']);
